...
class AGCL(GraphRecommender):
    def __init__(self, conf, training_set, test_set):
        super(AGCL, self).__init__(conf, training_set, test_set)
        ...
        self.model = AGCL_Encoder(self.data, self.emb_size, drop_rate, n_layers, temp, hyperedge_num, hypermap_layer)
    ...
    def train(self):
        ...
        for epoch in range(self.maxEpoch):
            ...
            for n, batch in enumerate(next_batch_pairwisev2(self.data, self.batch_size)):
                ...
                cl_loss = self.cl_rate * (model.cal_cl_loss(local_user_emb_list, local_item_emb_list, global_user_emb_list, global_item_emb_list, [user_idx,pos_idx]))
