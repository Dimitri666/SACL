...
@jit(nopython=True)
def find_k_largest1(K, candidates):
    n_candidates = []
...
if __name__=='__main__':
    '''
    list = np.random.randint(0,10000,size=5000)
    print(list)
    t1 = time.time()
    print(find_k_largest(20, list))
    t2 = time.time()
    print(f't1 {t2-t1}')
    print(find_k_largest1(20, list))
    t3 = time.time()
    print(f't2 {t3-t2}')
    '''